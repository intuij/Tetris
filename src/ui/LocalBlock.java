...
public class LocalBlock extends Block {
	private static final Image LOCAL_STR = new ImageIcon("graphics/string/disk.png").getImage();
	...
	public LocalBlock(int x, int y, int width, int height) {
	...
	void paint(Graphics g) {
		super.display(g);
		g.drawImage(LOCAL_STR, posX + PADDLE, posY + PADDLE, null);
